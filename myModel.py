...
#——————————————————————————————————————————————————————————————————————————————————以下
        ...
        for t in range(0, self.time_number):
            if t==0:
                ...
                user_z = self.act(torch.matmul(self.self_attention(self.weight_dict, self.embedding_dict['times_user_embedding'][t-1], self.embedding_dict['times_user_embedding'][t]), self.weight_dict['w_self_attention_user']))
